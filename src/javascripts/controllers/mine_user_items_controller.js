...
const plus_template = require('../views/mine/mine_plus.html')
...
const render =  async() => {
    ...
    let _plus_template = Handlebars.compile(plus_template)
